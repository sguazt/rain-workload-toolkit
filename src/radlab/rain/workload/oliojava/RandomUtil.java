...
/**
 * Utility for randomly generated information.
 * <br/>
 * NOTE: Code based on {@code radlab.rain.workload.olio.RandomUtil}
 * class and adapted for the Java version of Olio.
 */
public class RandomUtil {

	public static final String[] COUNTRIES = { "Albania", "Algeria",
	...
	public static String randomCountry(Random r) {
		return COUNTRIES[r.random(0, COUNTRIES.length - 1)];
	}
    ...
    public static String randomEvent(Random r, StringBuilder eventListPage) {
		return randomEvent(r, eventListPage, null);
    }

    public static String randomEvent(Random r, StringBuilder eventListPage, String pageType) {
        String search1 = "<a href=\"" + OlioGenerator.CONTEXT_ROOT + "/event/detail?socialEventID=";
        int idx = 0;
        ...
        if (size == 0)
		{
			...
			{
        		Logger logger = Logger.getLogger(RandomUtil.class.getName());
				logger.severe(search1 + " not found in " + pageType + " response! Response was:\n\n" + eventListPage + "\n\n\n");
			}
			return null;
		}
