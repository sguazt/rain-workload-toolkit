 ...
 * SocialEvent loader.
 * <br/>
 * NOTE: Code based on {@code org.apache.olio.workload.loader.SocialEvent}
...
public class SocialEvent extends Loadable {
    ...
    public void prepare() {
        ...
        fields[3] = UserName.getUserName(r.random(1, ScaleFactors.getLoadedUsers())); //submitterUserName
        ...
        createdTimestamp = r.makeDateInInterval( //createdtimestamp
                                        BASE_DATE, -540, 0);
        ifields[0] = r.random(1, ScaleFactors.getLoadedUsers()); // addressId
