 ...
 * 1) Initialization of loadedUsers to -1
 * 2) Added methods:
 *    - getActiveUsers,
 *    - getLoadedUsers,
 *    - getTags.
 ...
 * and load generation.
 * <br/>
 * NOTE: Code based on {@code radlab.rain.workload.olio.ScaleFactors}
...
public class ScaleFactors 
{
	...
	public static int loadedUsers = -1;
	...
	public static int getLoadedUsers()
	{
		return loadedUsers;
	}
